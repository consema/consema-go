...
// §10; crates/consema-core/src/value.rs:622-652: Null, Boolean, Integer,
...
// codec (crates/consema-pvce/src/lib.rs) and its canonical bytes are pinned by
...
// EntryMappingBuilder (crates/consema-core/src/value.rs:959-984).
//
...
// order, crates/consema-core/src/value.rs:622-652).
const (
...
// §10.5; the Rust Bytes kind, crates/consema-core/src/value.rs:737-739). No
...
// the Rust EntryMappingEntry, crates/consema-core/src/value.rs:600-618).
...
// Rust EntryMappingBuilder::push semantics, crates/consema-core/src/value.rs:
// 973-978).
