...
// 标准与 Rust 参考实现.md §10.6; crates/consema-core/src/value.rs:419-576):
...
// crates/consema-core/src/value.rs:420-464). The year is an arbitrary
...
// crates/consema-core/src/value.rs:467-517). The fractional second is an
...
// rule, crates/consema-core/src/value.rs:337-352). An invalid time returns a
// *PVCEError with ErrInvalidTemporal.
...
// crates/consema-core/src/value.rs:520-544). It is not a timestamp.
...
// OffsetDateTime, crates/consema-core/src/value.rs:547-576). The offset
...
// crates/consema-core/src/value.rs:429-445). The leap rule uses the absolute
...
// Time::new checks, crates/consema-core/src/value.rs:483-485).
...
// crates/consema-core/src/value.rs:337-352): a non-negative coefficient, and
