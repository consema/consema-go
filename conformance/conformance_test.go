...
func TestApplicableSuiteCounts(t *testing.T) {
	...
	expected := map[string][3]int{
		...
		"consema.ini.conformance@1":               {0, 20, 0},
		"consema.java-properties.conformance@1":   {0, 22, 0},
		"consema.xml-1-0-safe.conformance@1":      {0, 34, 0},
		"consema.plist.conformance@1":             {0, 45, 0},
