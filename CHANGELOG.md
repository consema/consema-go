...
- 验证基线：19 包全绿（LF 规范态含 race）、conformance 508/508（18 套 / 聚合 digest 35bebc8d 共钉）、差分 108/108 双向、协议交换 83/83、字节 parity 68/68、capability parity PASS、16 fuzz targets 30s clean-run；
- CI（ci-go.yml）：Go 1.26 门禁（gofmt/vet/build/test/race）+ Go-Rust 差分门禁；
