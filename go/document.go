...
// (crates/consema/src/lib.rs `Document::parse_yaml`). The YAML family
// parse entry has no cancellation; the facade mirrors that.
...
// encoding selection (crates/consema/src/lib.rs `Document::parse_ini`).
...
// profile and source contract (crates/consema/src/lib.rs
...
// explicit encoding selection (crates/consema/src/lib.rs
...
// encoding selection (crates/consema/src/lib.rs `Document::parse_hcl`).
