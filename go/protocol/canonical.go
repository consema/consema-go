...
// to the Rust transport (crates/consema-protocol/src/value_transport.rs).
//
...
// (crates/consema-protocol/src/value_transport.rs:26-53, using the strict
...
// (crates/consema-protocol/src/value_transport.rs:26-75). The record decode
...
// limits (crates/consema-protocol/src/value_transport.rs:78-89).
...
// (crates/consema-protocol/src/value_transport.rs:92-112). The Go codec
