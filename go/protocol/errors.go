...
// (consema-rs/consema-protocol/src/error.rs); each kind maps to one frozen
...
// mapping (consema-rs/consema-protocol/src/error.rs; the error-code registry
...
// consema-rs/consema-protocol/src/error.rs).
