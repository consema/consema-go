...
// (the Rust GraphMatchIdentity, consema-rs/crates/consema-graph/src/query.rs:78-83):
...
func identityOfPortable(match PortableMatch) string {
	...
	// consema-rs/crates/consema-core/src/query.rs:2248-2262), not a structural proxy:
