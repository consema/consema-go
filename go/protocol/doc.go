...
// for Go (RFC 0016 §3.2; https://github.com/consema/consema/blob/main/docs/go-implementation-plan.md §2.1 G0.3). It maps
// consema-rs/consema-protocol: the frozen contract registry (semantic-model v7,
