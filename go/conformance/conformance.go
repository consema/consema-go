...
var allSuites = []suiteDefinition{
	...
	{File: "yaml-v1.json", SuiteID: "consema.yaml.conformance@1", ExpectedCases: 27, Run: runYamlV1},
	...
	{File: "java-properties-v1.json", SuiteID: "consema.java-properties.conformance@1", ExpectedCases: 22, Run: runJavaPropertiesV1},
	{File: "xml-1-0-safe-v1.json", SuiteID: "consema.xml-1-0-safe.conformance@1", ExpectedCases: 34, Run: runXml10SafeV1},
	{File: "plist-v1.json", SuiteID: "consema.plist.conformance@1", ExpectedCases: 45, Run: runPlistV1},
