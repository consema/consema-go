...
// The four frozen argument kinds.
const (
...
// scalar capabilities (replace-scalar-semantic, replace-scalar-literal).
func NewFormatOperationRegistry(profile TomlProfile) FormatOperationRegistry {
	return FormatOperationRegistry{
		profile: profile.ID(),
		operations: []OperationDescriptor{
			{
				ID:         *protocol.NewFormatOperationId("toml.edit.insert-entry", 1),
			...
			{
				ID:         *protocol.NewFormatOperationId("toml.edit.remove-entry", 1),
				TargetRole: "toml.entry@1",
				Support:    OperationSupportSupported,
			},
			{
				ID:         *protocol.NewFormatOperationId("toml.edit.rename-entry", 1),
				TargetRole: "toml.entry@1",
				Arguments: []OperationArgumentDescriptor{
					{Name: "key", Kind: OperationArgumentString},
				},
			...
			{
				ID:         *protocol.NewFormatOperationId("toml.edit.insert-array-element", 1),
			...
			{
				ID:         *protocol.NewFormatOperationId("toml.edit.remove-array-element", 1),
				TargetRole: "toml.array-element@1",
				Support:    OperationSupportSupported,
			},
			{
				ID:         *protocol.NewFormatOperationId("toml.edit.replace-scalar-semantic", 1),
			...
			{
				ID:         *protocol.NewFormatOperationId("toml.edit.replace-scalar-literal", 1),
				TargetRole: "toml.scalar-item@1",
				Arguments: []OperationArgumentDescriptor{
