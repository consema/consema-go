...
// TOML format family (RFC 0001; consema-rs/consema-toml). It forms lossless
...
// (https://github.com/consema/consema/blob/main/docs/go-implementation-plan.md §1.3). Completed public objects are
