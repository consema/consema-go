...
// composition (consema-rs/consema/src/conversion.rs; RFC 0016 §3.2:
// convert lives in the root package only — G057, adversarial audit
// 2026-08-14: the "line 108" reference was dropped; the sentence is the
// anchor).
//
