...
//
// The package mirrors the capability face of consema-rs/consema-properties
// (https://github.com/consema/consema/blob/main/docs/go-implementation-plan.md §2.3 G2.3): explicit profile and
...
// Properties line grammar (https://github.com/consema/consema/blob/main/docs/go-implementation-plan.md §1.3 rejects
