...
// codec, crates/consema-graph/src/pgce.rs (RFC 0006 §5; RFC 0016 §4.1:
// 144-146):
//
...
// crates/consema-graph/src/pgce.rs:12).
var magicPGCE = [4]byte{'P', 'G', 'C', 'E'}

// pgceVersion is the frozen PGCE/1 version
// (crates/consema-graph/src/pgce.rs:14).
const pgceVersion = 1
...
// §6; the Rust PgceLimits, crates/consema-graph/src/pgce.rs:21-54). The zero
...
// 1 MiB tag, 64 MiB scalar, depth 256; crates/consema-graph/src/pgce.rs:
// 41-54).
...
// Rust PgceLimits::graph_limits, crates/consema-graph/src/pgce.rs:56-68).
...
// to the Rust codec's output (crates/consema-graph/src/pgce.rs:219-221); a
...
// crates/consema-graph/src/pgce.rs:224-275). It never truncates: exceeding
...
// crates/consema-graph/src/pgce.rs:277-284).
...
// crates/consema-graph/src/pgce.rs:286-339). Go int arithmetic cannot
...
// Rust blob_size, crates/consema-graph/src/pgce.rs:348-350).
...
// Rust check_encode_limit, crates/consema-graph/src/pgce.rs:360-374).
...
// map_build_to_encode, crates/consema-graph/src/pgce.rs:376-390). Only the
...
// Rust write_varint, crates/consema-graph/src/pgce.rs:398-410).
...
// LEB128 (the Rust const varint_size, crates/consema-graph/src/pgce.rs:
// 412-419).
...
// mirroring the Rust decode (crates/consema-graph/src/pgce.rs:422-507). The
...
func DecodePGCE(stream []byte, limits PGCELimits) (*Graph, error) {
	...
	for i := 0; i < nodeCount; i++ {
		...
		case nodeMapping:
			...
			// crates/consema-graph/src/pgce.rs:477-480).
...
// 64-bit overflow (the Rust Decoder::varint, crates/consema-graph/src/pgce.rs:
// 539-557).
...
// Rust check_decode_limit, crates/consema-graph/src/pgce.rs:597-611).
...
// failures (the Rust map_build_to_decode, crates/consema-graph/src/pgce.rs:
...
// (the Rust map_encode_to_decode, crates/consema-graph/src/pgce.rs:629-642):
