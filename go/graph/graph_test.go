...
// (consema-rs/consema-graph/src/lib.rs): a mapping whose key is a shared
...
// (consema-rs/consema-graph/src/lib.rs): two graphs built with different
...
// (consema-rs/consema-graph/src/lib.rs): reversing the association order
...
// (consema-rs/consema-graph/src/lib.rs): node, edge, and traversal-depth
...
// (consema-rs/consema-graph/src/lib.rs): construction failures carry the
