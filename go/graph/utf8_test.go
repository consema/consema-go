...
// valid UTF-8 (the Arc<str> invariant, crates/consema-graph/src/lib.rs:
...
// Decoder::string InvalidUtf8, crates/consema-graph/src/pgce.rs:576-586).
...
// (crates/consema-graph/src/pgce.rs:502-504) and no test drives it either;
