...
// encoder, generated with the reference codec itself (consema-rs/crates/consema-pvce)
// for the exact values of the Rust every_core_kind_round_trips test
// (consema-rs/crates/consema-pvce/src/lib.rs:1129-1174): BinaryFloat32(0x7fc0_0001),
...
// (consema-rs/crates/consema-pvce/src/lib.rs:1129-1174) for the additional kinds:
...
// (consema-rs/crates/consema-pvce/src/lib.rs:736-774, 895-940) and the
...
func TestNewKindTemporalDecodeRejections(t *testing.T) {
	cases := []struct {
		...
		// (consema-rs/crates/consema-core/src/value.rs:1183-1186): year -400 is a leap
...
// (consema-rs/crates/consema-core/src/value.rs:1183-1186): the leap rule operates on the
...
// Decimal::is_fraction, consema-rs/crates/consema-core/src/value.rs:337-352): the
...
// OffsetDateTime::new, consema-rs/crates/consema-core/src/value.rs:553-563).
...
// (the Rust decode limits, consema-rs/crates/consema-pvce/src/lib.rs:848-940). The
