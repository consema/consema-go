...
// encoder, generated with the reference codec itself (crates/consema-pvce)
// for the exact values of the Rust every_core_kind_round_trips test
// (crates/consema-pvce/src/lib.rs:1129-1174): BinaryFloat32(0x7fc0_0001),
...
// (crates/consema-pvce/src/lib.rs:1129-1174) for the additional kinds:
...
// (crates/consema-pvce/src/lib.rs:736-774, 895-940) and the
...
func TestNewKindTemporalDecodeRejections(t *testing.T) {
	cases := []struct {
		...
		// (crates/consema-core/src/value.rs:1183-1186): year -400 is a leap
...
// (crates/consema-core/src/value.rs:1183-1186): the leap rule operates on the
...
// Decimal::is_fraction, crates/consema-core/src/value.rs:337-352): the
...
// OffsetDateTime::new, crates/consema-core/src/value.rs:553-563).
...
// (the Rust decode limits, crates/consema-pvce/src/lib.rs:848-940). The
