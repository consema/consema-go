...
// ParseLimits, MaterializationRequest, and SourcePatch.
//
...
// ban) and depends only on the Go standard library. The wire-facing
// records of go/protocol (records_source.go: core.source-snapshot@1/@2,
// core.source-patch@1/@2, core.source-encoding@1) carry the same facts in
// their transferable shapes; the two layers stay aligned by shared
// semantics, verified by the field-consistency tests in this package.
//
...
// Code() contract: *SourceError, *SourcePatchError, *LocationError, and
// *SourcePatchRedactionError. Error text is human presentation only and
